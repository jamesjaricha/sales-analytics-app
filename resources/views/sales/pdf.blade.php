        ...
        <tr>
            <td style="font-size: 16px; font-weight: bold;">
                ...
                <div style="font-size: 9px; font-weight: normal; color: #d1fae5;">
                    Cash {{ number_format($report->total_cash, 2) }} less cash expenses {{ number_format($cashExpenses, 2) }} &middot; B/F float {{ number_format((float) ($report->opening_balance ?? 0), 2) }} kept separate
                </div>
            </td>
